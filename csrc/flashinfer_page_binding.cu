...
TVM_FFI_DLL_EXPORT_TYPED_FUNC(append_paged_kv_cache_prefill, append_paged_kv_cache_prefill);
TVM_FFI_DLL_EXPORT_TYPED_FUNC(append_paged_kv_cache_decode, append_paged_kv_cache_decode);
