...
def apply_rotary_pos_emb(q, k, cos, sin, position_ids=None, unsqueeze_dim=1):
    ...
    return q_embed.squeeze(0).transpose(0, 1), k_embed.squeeze(0).transpose(0, 1)
...
class LlamaForCausalLM(LlamaPreTrainedModel, GenerationMixin):
    ...
    def prepare_inputs_for_generation(self, input_ids, **kwargs):
        seq_len = self.model.attn_runner.cache_manager.seq_len
        if seq_len == 0:
            ...
            return {"input_ids": input_ids[:, -1:], "position_ids": position_ids}
